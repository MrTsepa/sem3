...
/*
 * ! Увпевают скопироваться потому, что вы выделяете под каждое сообщение свой кусок памяти в куче, а передаёте в ф-ю thread_func указатель по значение, т.е.
 *  фактически копируете указатель. Вам не обязательно совершенно было копировать резульатат в какую-то дополнительную локальную переменную внутри данной ф-и.
 */
